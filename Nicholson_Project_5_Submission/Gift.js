function setup() {
    ...
    function draw() {
        ...
        function drawCube(color, TxU, scale) {
            ...
            context.strokeStyle = color;
            // Twelve edges of a cropped pyramid
            moveToTx([-3, -3, -3], Tx); lineToTx([3, -3, -3], Tx);
            lineToTx([3, 3, -3], Tx); lineToTx([-3, 3, -3], Tx);
            moveToTx([3, -3, -3], Tx); lineToTx([3, -3, 3], Tx);
            lineToTx([3, 3, 3], Tx); lineToTx([3, 3, -3], Tx);
            moveToTx([3, -3, 3], Tx); lineToTx([-3, -3, 3], Tx);
            lineToTx([-3, 3, 3], Tx); lineToTx([3, 3, 3], Tx);
        ...
        drawTrajectory(0.0, 1.0, 100, C0, tVP_PROJ_VIEW_Camera, "orange");
        drawTrajectory(0.0, 1.0, 100, C1, tVP_PROJ_VIEW_Camera, "orange");
        ...
        drawCube("red", tVP_PROJ_VIEW_Camera, 10.0);
        ...
        drawTrajectory(0.0, 1.0, 100, C0, tVP_PROJ_VIEW_Observer, "orange");
        ...
        drawCube("red", tVP_PROJ_VIEW_Observer, 10.0);
    }
